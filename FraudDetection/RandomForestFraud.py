...
overSampler = SMOTE(ratio='auto', random_state=np.random.randint(100), k_neighbors=5,
...
# OVER SAMPLE TRAINING AND TESTING SETS
...
print("Recall:", confusionMatrix[1][1] /
      (confusionMatrix[1][1] + confusionMatrix[1][0]))
print("Precision:", confusionMatrix[1][1] /
